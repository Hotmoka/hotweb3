...
export declare class StaticMethodCallTransactionRequestModel extends MethodCallTransactionRequestModel {
     ...
     */
    constructor(caller: StorageReferenceModel, nonce: string, chainId: string, gasLimit: string, gasPrice: string, classpath: TransactionReferenceModel, method: MethodSignatureModel, actuals: Array<StorageValueModel>, signer?: Signer);
    /**
