...
export declare class Constants {
     ...
     */
    static readonly IO_TAKAMAKA_CODE_PACKAGE_NAME = "io.takamaka.code.";
    /**
     * The name of the package of the Takamaka tokens classes.
     */
    static readonly IO_TAKAMAKA_CODE_TOKENS_PACKAGE_NAME: string;
    /**
     * The name of the package of the Takamaka utility classes.
     */
    static readonly IO_TAKAMAKA_CODE_UTIL_PACKAGE_NAME: string;
    /**
     * The name of the package of the Takamaka language classes.
     */
    static readonly IO_TAKAMAKA_CODE_LANG_PACKAGE_NAME: string;
    /**
     * The name of the class type for {@link io.takamaka.code.lang.PayableContract}.
     */
    static readonly PAYABLE_CONTRACT_NAME = "io.takamaka.code.lang.PayableContract";
    /**
     * The name of the class type for {@link io.takamaka.code.util.StorageLinkedList.Node}.
     */
    static readonly STORAGE_LINKED_LIST_NODE_NAME = "io.takamaka.code.governance.ConsensusUpdate";
    /**
     * The name of the class type for {@link io.takamaka.code.util.StorageTreeMap.Node}.
     */
    static readonly STORAGE_TREE_MAP_NODE_NAME = "io.takamaka.code.util.StorageTreeMap$Node";
    /**
     * The name of the class type for {@link io.takamaka.code.util.StorageListView}.
     */
    static readonly STORAGE_LIST_VIEW_NAME = "io.takamaka.code.util.StorageListView";
    /**
